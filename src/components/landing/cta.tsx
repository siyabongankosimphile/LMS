  ...
  return (
    <section className="bg-gradient-to-r from-slate-950 to-slate-700 text-center text-white">
      <div className="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <Link href="/login" className="mt-8 inline-block rounded-full bg-cyan-300 px-10 py-4 text-lg font-semibold text-slate-900 shadow-lg shadow-cyan-500/30 transition hover:-translate-y-0.5 hover:bg-cyan-200">
          Enroll Now
        </Link>
      </div>
    </section>
